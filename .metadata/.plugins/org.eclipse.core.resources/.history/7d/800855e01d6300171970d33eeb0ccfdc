...
import com.revature.rideshare.data.jpa.domain.Rating;
import com.revature.rideshare.data.jpa.domain.RatingCount;
import com.revature.rideshare.data.jpa.domain.Review;
import com.revature.rideshare.data.jpa.domain.ReviewDetails;
